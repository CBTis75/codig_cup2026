...
def solve():
    # Leer todo el input de golpe para máxima velocidad
    ...
    while ptr < len(input_data):
        ...
        if tipo == 'U':
            ...
            # El truco: recorrer filas y usar slicing para las columnas
            # El slicing mat[i][c1:c2+1] está implementado en C internamente
